...
sudo cp -R ../../cef_binary_76.1.13+gf19c584+chromium-76.0.3809.132_macosx64_minimal/Release/Chromium\ Embedded\ Framework.framework OBS.app/Contents/Frameworks/
